...
public class MarkitClientTest {
    ...
    public void testSendFile() throws IOException, InterruptedException {
        ...
        String response = client.request().with(request.getFile()).send();
    ...
    public void testSendStringWithRetry() throws IOException, InterruptedException {
        ...
        String response = client.request().withKey("key").retryUntil(s -> s.startsWith(STILL_PROCESSING_KEY)).send();
    ...
    public void testSendString() throws IOException, InterruptedException {
        ...
        String response = client.request().withAsOfDate(asOfDate).send();
