...
public class MarkitPricingServiceTest {
    ...
    @Rule
    public ResourceFile all = new ResourceFile("/excel/TradePortfolio09-05-17.xlsx");
    ...
    private List<SwapTrade> loadTrades(ResourceFile file) {
        final List<String> tradeIds = tradeUploadService.uploadTradesFromExcel(file.createInputStream());
