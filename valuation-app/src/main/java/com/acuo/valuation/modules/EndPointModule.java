...
import com.acuo.valuation.providers.datascope.service.DatascopeClient;
...
public class EndPointModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(new TypeLiteral<ClientEndPoint<DatascopeEndPointConfig>>(){}).to(DatascopeClient.class);
    }
